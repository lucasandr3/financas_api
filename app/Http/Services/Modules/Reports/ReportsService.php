...
namespace App\Http\Services\Modules\Reports;

use App\Helpers\Constants;
use App\Helpers\Helpers;
use App\Http\Interfaces\Repositories\Modules\Reports\ReportsRepositoryInterface;
...
class ReportsService implements ReportsServiceInterface
{
    ...
    (
        ReportsRepositoryInterface $repository
    )
    {
